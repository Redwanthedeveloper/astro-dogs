  ...
  return (
    <>
      ...
      <div className='banner h-[100vh] relative' style={{background: `url(${bannerImage})`, height: '100vh', backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundPosition: 'top left'}}>
        <div className='container mx-auto' style={{maxWidth: '1140px', margin:'auto', height: '100%', display: 'flex', flexDirection:'column', background: 'transparent', justifyContent:'center'}}>
         <CountDown/>
          {/* <div className='text-white w-96' style={{display: 'flex', flexDirection:'column', background: 'transparent', maxWidth: '80%', margin: 'auto', justifyContent:'center', alignItems: 'center', gap: '2rem', fontWeight: 500, position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', padding: '2rem 8rem', borderRadius: '.5rem ', zIndex: 999, }}>
          {wallet && (
