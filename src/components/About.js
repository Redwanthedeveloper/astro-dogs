...
const About = () => {
  return (
    <>
      <div className='about mt-0 lg:mt-24 py-16 lg:py-24 ' id='about'>
        <div className='container mx-auto'>
          ...
          >
            ...
            <div className='about__content col-span-2'>
              <h1 className='font-bold text-4xl text-center pb-6 lg:pb-12 text-default lg:text-left lg:text-5xl'>
                What are Astro Dogs
              </h1>
